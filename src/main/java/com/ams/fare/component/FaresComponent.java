package com.ams.fare.component;
...
public class FaresComponent
{
    ...
    {
        logger.info("Getting for fares flightNumber " + flightNumber + " flightDate " + flightDate);
        return faresRepository.getFareByFlightNumberAndFlightDate(flightNumber,
                                                                  flightDate);
    }
}
